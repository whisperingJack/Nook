<!DOCTYPE html>
<!--
hgvuhgjhvjhvjhvjhvjhvj ADD IOS AND HHTPS TO CHECKLIST, added browsers: chrome desktop -mobile, added android. Added canonical tag.Added mobile-speed to speedtest details.  ADD FIGURE TAGS > FIGCAPTION FOR IMAGES ADDED BLACKHAT TRAFFIC.-->
<html>
...
<main>
   ...
   -- </nav>-->
	...
	<section class="checklist-section">
		...
		<div>
			...
			<li>
				...
				<h3 class="useability_score">Total Useability Score:&nbsp;&nbsp;<span id="useability_score"></span>&nbsp;/ 16</h3>
            </li>
            </ul>
	   ...
	   <p>Do you have the right files on the server with your website, is your connection verified and secure. Is your configuration file set up properly and to it's full potential.</p>
		...
		<div>
			...
			<li>
				<h4 class="server_score">Server Score: <span id="server_score"></span>&nbsp;/&nbsp;6</h4>
    ...
    <div>
        <ul>
            <li>
				<h3 class="optimisation_notes">Total Optimisation Score:&nbsp;&nbsp;<span id="optimisation_score"></span>&nbsp;/ 39</h3> 
        ...
        <div>
			...
			<div>
                 <h3 class="targeting_score">Total Targeting Score:&nbsp;&nbsp;<span id="targeting_score"></span>&nbsp;/ 18</h3>
            <ul>
                <li>
		...
		<section  class="checklist-section">
			...
			<div>
                ...
                <li>
					<span class="radio_title">No Unusual Traffic Spikes</span>
					<label class="radio_label"><input type="radio"  class="radio analytics blackhat" name="Blackhat_BTraffic" value="1">Yes</label>
					<label class="radio_label"><input type="radio"  class="radio analytics blackhat" name="Blackhat_Backlinks" value="0"> No</label>
				</li>
				<li>
					<label class="notes_label">Summary</label>
				...
				<li>
					<h4 class="blackhat_score">Blackhat Score: <span id="blackhat_score"></span>&nbsp;/&nbsp;3</h4>
			...
			<div>  
				<h3 class="analytics_score">Total Analytics Score&nbsp;<span id="analytics_score"></span>&nbsp;/ 13</h3> 
            <ul>
                <li>
		...
		<section  class="checklist-section">
			<div>
				<h3>Total Site Score:&nbsp;&nbsp;<span id="score"></span>&nbsp;/&nbsp;86</h3>
